...
class _$RegisterStateImpl implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(email: $email, password: $password, vPassword: $vPassword, name: $name, phone: $phone, address: $address, termsOK: $termsOK)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, email, password, vPassword, name, phone, address, termsOK);
