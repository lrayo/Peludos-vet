...
import 'package:peludos_pet/app/animations/cat_animation.dart';
...
final welcomeProvider = SimpleProvider(
  (_) => WelcomeController(sessionProvider.read),
  autoDispose: true,
);
...
class _WelcomeState extends State<Welcome> {
  ...
  Widget build(BuildContext context) {
    return ProviderListener<WelcomeController>(
      provider: welcomeProvider,
      onChange: (_, controller) {
        final route = controller.routeName;
        if (route != null) {
