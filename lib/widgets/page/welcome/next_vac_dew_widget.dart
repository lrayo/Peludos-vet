...
class NextVacDew extends StatelessWidget {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  daysUntilNextDeworming(), // Días restantes hasta la próxima desparasitación
                  style: GoogleFonts.inter(
                    fontSize: 20.0,
                    fontWeight: FontWeight.w500,
                    color: Colors.black,
  ...
  String daysUntilNextVaccination() {
    ...
    final nextVaccination = vaccinationDate.isBefore(now)
        ? DateTime(vaccinationDate.year + 1, vaccinationDate.month, vaccinationDate.day) 
        : vaccinationDate;
  ...
  String daysUntilNextDeworming() {
    ...
    while (targetDate.isBefore(now)) {
      targetDate = targetDate.add(interval); // Sumar 120 días para la próxima desparasitación
    }
